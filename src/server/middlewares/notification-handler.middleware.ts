...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order.create': { roles: ['owner', 'hr-manager', 'hr-staff'], key: 'order_123', tenantPath: [], userPath: [] },
  'Employee.create': { roles: ['owner', 'hr-manager', 'hr-staff'], key: 'employee_123', tenantPath: [], userPath: [] },
  'Employee.update': { roles: ['owner', 'hr-manager', 'hr-staff'], key: 'employee_123', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'hr-manager', 'hr-staff', 'employee', 'applicant'];
