  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="MatCore: Streamlining Your HR Processes. Experience the Next Level of Human Resource Management Efficiency with Us"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`MatCore: Streamlining Your HR Processes. Experience the Next Level of Human Resource Management Efficiency with Us`}
            </Text>
            <Box
